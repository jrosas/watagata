{-|
  ...
  Definici&#243;n del lenguaje /Vectorinox/ basado en el tipo b&#225;sico
  /Tokens/ con distintos constructores, tal como se definio en el enunciado
  de este proyecto. Esta definici&#243;n es exportable y utilizada por Lexer.x
